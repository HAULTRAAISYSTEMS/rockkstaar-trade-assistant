...
def _swing_defaults(data: dict) -> None:
    ...
    data.setdefault("fib_236",                None)
    data.setdefault("fib_382",                None)
    data.setdefault("fib_65",                 None)
    data.setdefault("fib_705",                None)
    data.setdefault("fib_786",                None)
    data.setdefault("fib_confidence",         None)
    data.setdefault("fib_direction",          None)
    data.setdefault("fib_mode",               None)
    data.setdefault("macro_fib_high",         None)
    data.setdefault("macro_fib_low",          None)
    data.setdefault("macro_fib_50",           None)
    data.setdefault("macro_fib_618",          None)
    data.setdefault("h4_fib_high",            None)
    data.setdefault("h4_fib_low",             None)
    data.setdefault("h4_fib_50",              None)
    data.setdefault("h4_fib_618",             None)
