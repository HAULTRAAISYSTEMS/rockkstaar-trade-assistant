...
CATALYST_CATEGORIES: dict[str, dict] = {
    ...
    "analyst_upgrade": {
        "keywords": [
            "analysts upgrade", "analyst upgrade", "upgrade to", "price target raised", "raises price target", "buy rating",
    ...
    "analyst_downgrade": {
        "keywords": [
            "analysts downgrade", "analyst downgrade", "downgrade to", "underperform", "underweight", "sell rating",
    ...
    "guidance_raise": {
        "keywords": [
            ...
            "raises profit forecast",
            "raises fy",
            "upgrades its outlook",
            "upgrades its full-year",
            "increases guidance",
            "raises its outlook",
            "raises its forecast",
            "sees higher full-year",
        ],
        "weight": 4,
